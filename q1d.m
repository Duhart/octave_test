% This is an auxiliary script for Q1d of Assignment 3
% Same script as in q1c, the only difference is that
% initial conditions were changed from u0=[2 1] to u0=[1 1]
...
for(k=4:10)
    ...
    subplot(2,2,3), hold on, plot(ue(:,1),ue(:,2),'b+');
...
for(k=4:10)
    ...
    subplot(2,2,3), hold on, plot(u2(:,1),u2(:,2),'b+');
